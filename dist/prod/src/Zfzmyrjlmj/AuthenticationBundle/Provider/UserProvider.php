...
namespace Yaraclinica\AuthBundle\Provider;
...
class UserProvider implements UserProviderInterface
{
    ...
    public function loadUserByUsername($credential)
    {
    ...
    public function refreshUser(UserInterface $user)
    {
        ...
        return $this->userRepository->find($user->getUserId());
    }
